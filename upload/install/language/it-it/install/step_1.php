<?php
// Heading
$_['heading_title']  = 'Contratto di Licenza';

// Text
$_['text_step_1']    = 'Per favore leggi il Contratto di Licenza di OpenCart';
$_['text_terms'] = '<h3>GNU GENERAL PUBLIC LICENSE</h3>
      ...
      <p>A chiunque &egrave; permesso copiare e ridistribuire copie esatte di questo documento di licenza, ma non &egrave; in alcun modo consentito apportarvi modifiche.</p>
      <h3><a name="preamble"></a>Premessa</h3>
      <p>
		La GNU General Public License &egrave; una licenza libera e basata su copyleft
		per software e altri tipi di opere.

		<div class="p"><!----></div>
		Le licenze della maggior parte del software e di altre opere materiali
		sono pensate per togliere la libert&agrave; di condividere e modificare
		tali opere. Al contrario, la GNU General Public License ha l\'obiettivo
		di garantire la libert&agrave; di condividere e modificare tutte le versioni
		...
		questa licenza. Chiunque pu&ograve; utilizzare questa licenza per i suoi
		programmi. 

		<div class="p"><!----></div>
		Quando parliamo di software libero (free software), ci riferiamo al
		concetto di libert&agrave;, non al prezzo. Le nostre General Public License
		sono progettate per garantire che chiunque abbia la libert&agrave; di
		...
		<div class="p"><!----></div>
		Per proteggere i vostri diritti, abbiamo la necessit&agrave; di impedire che
		...
		assume dei precisi doveri: il dovere di rispettare la libert&agrave; degli
		altri.
		...
		conoscere ai destinatari del software queste condizioni, cos&igrave; che essi
		...
		chiaramente che non c\'&egrave; nessuna garanzia per questo software
		...
		gira sugli stessi, anche se il costruttore si riserva la possibilit&agrave;
		di farlo. Ci&ograve; &egrave; fondamentalmente incompatibile con l\'obiettivo di
		garantire la libert&agrave; degli utenti di modificare il software. Una
		ripetizione sistematica di tali abusi avviene nel campo dei dispositivi
		per usi individuali, e ci&ograve; rende questi abusi ancora pi&ugrave;
		...
		ambiti in versioni future della GPL, nella maniera che si render&agrave;
		necessaria per difendere la libert&agrave; degli utenti.
		...
		computer, ma nei Paesi in cui ci&ograve; avviene noi vogliamo evitare in
		particolare il pericolo che i brevetti sul software applicati ad un
		programma libero possano renderlo, a tutti gli effetti,
		proprietario. Per impedire ci&ograve;, la GPL assicura che non &egrave; possibile
		...
		disposizione al pubblico e, in alcuni stati, altre attivit&agrave; simili e
		connesse.
		...
		sia alcun trasferimento di una copia, non &egrave; considerata
		"Distribuzione".
		...
		funzionalit&agrave;, resa adeguatamente visibile, che (1) visualizzi
		un\'adeguata informazione di copyright, e (2) informi l\'utente che non
		c\'&egrave; alcuna garanzia sull\'opera (eccetto nel caso in cui delle garanzie
		sono espressamente fornite), dica che il licenziatario pu&ograve; distribuire
		l\'opera utilizzando questa Licenza, indichi come &egrave; possibile prendere
		visione di una copia di questa Licenza. Se l\'interfaccia presenta una
		lista di comandi o di opzioni, come ad esempio un men&ugrave;, una delle
		...
		<div class="p"><!----></div>
		Il "codice sorgente" di un\'opera indica la forma pi&ugrave; indicata
		...
		<div class="p"><!----></div>
		Una "Interfaccia Standard" &egrave; una interfaccia che risponde ad uno
		...
		di pacchettizzazione di un "Componente Principale", ma che non &egrave;
		...
		<div class="p"><!----></div>
		Il Sorgente Corrispondente di un\'opera in forma di codice sorgente &egrave;
		l\'opera stessa.
		<div class="p"><!----></div>
		</li>
		...
		<div class="p"><!----></div>
		Distribuire opere coperte da licenza in qualunque altra circostanza &egrave;
		...
		<div class="p"><!----></div>
		Nessun programma protetto da questa Licenza pu&ograve; essere considerato
		...
		<div class="p"><!----></div>
		Ti &egrave; permesso distribuire copie esatte del codice sorgente del
		...
		<ol type="a">
		<li> l\'opera deve recare con s&egrave; delle informazioni adeguate che
			affermino che tu l\'hai modificata, indicando la data di modifica.
		<div class="p"><!----></div>
		</li>

		<li>
			l\'opera deve recare informazioni adeguate che affermino che essa &egrave;
		...
		<div class="p"><!----></div>
			Una porzione separabile del codice oggetto, il cui sorgente &egrave;
		...
		<div class="p"><!----></div>
		Un "Prodotto Utente" &egrave; un (1) "prodotto consumer", cio&egrave;
		...
		il prodotto. Un prodotto &egrave; un "prodotto consumer" indipendentemente
		...
		<ol type="a">
		<li>	Negano la garanzia o limitano la responsabilit&agrave; del Programma in
		...
		<li>
			Rifiutano di garantire diritti secondo le leggi sulla propriet&agrave;
		...
		&egrave; possibile trovare copia delle condizioni aggiunte.
		...
		<div class="p"><!----></div>
		Una "transazione d\' entit&agrave;" &egrave; una transazione che trasferisce il
		...
		o se pu&ograve; ottenerlo senza troppe difficolt&agrave;.
		...
		<div class="p"><!----></div>
		Un "contribuente" &egrave; un detentore di copyright che autorizza l\'uso
		secondo questa Licenza di un Programma o di un\'opera basata sul
		Programma. l\'opera cos&igrave; licenziata viene chiamata "versione del
		contribuente". 
		...
		<div class="p"><!----></div>
		Una licenza di brevetto &egrave; "discriminatoria" se non include
		...
		<div class="p"><!----></div>
		Nessuna parte di questa Licenza pu&ograve; essere interpretata come atta ad
		...
		<li> Nessuna resa di libert&agrave; altrui
		...
		questa Licenza &egrave; evitare del tutto la distribuzione del Programma.
		<div class="p"><!----></div>
		</li>
		...
		<div class="p"><!----></div>
		La Free Software Foundation pu&ograve; pubblicare delle versioni rivedute
		...
		versione successiva", hai la possibilit&agrave; di sottostare alle
		...
		<div class="p"><!----></div>
		Se il Programma specifica che un sostituto o un procuratore pu&ograve;
		...
		"COSI\' COME &egrave;" SENZA GARANZIA DI ALCUN TIPO, NE\' ESPRESSA NE\'
		...
		<li> Limitazione di Responsabilit&agrave;
		...
		<div class="p"><!----></div>
		Se la dichiarazione di garanzia e la limitazione di responsabilit&agrave;
		...
		utilit&agrave;, il modo migliore &egrave; renderlo software libero in modo che
		chiunque possa ridistribuirlo e modificarlo secondo i termini di questa
		Licenza.

		<div class="p"><!----></div>
		Per fare ci&ograve;, allega le seguenti note informative al programma. Il
		modo migliore &egrave; inserirle all\'inizio di ciascun file sorgente, al fine
		...
		riferimento al posto in cui &egrave; possibile ottenere la versione completa
		...
		visualizzi, quando viene avviato in modalit&agrave; interattiva, un breve
		...
		all\'interno di software proprietario. Se il tuo programma &egrave; una
		libreria di funzioni, potresti ritenere pi&ugrave; opportuno consentire il
		collegamento tra software proprietario e la tua libreria. Se &egrave; questo
		ci&ograve; che vuoi, allora utilizza la GNU Lesser General Public License
		anzich&eacute; questa Licenza, ma prima leggi
		http://www.gnu.org/philosophy/why-not-lgpl.html.
		<div class="p"><!----></div>
		</li>
		</ol>
	  </p>
   <p>Qesta versione invia la tua mail, il dominio e questo path allo staff LBiT. I tuoi dati saranno 
   utilizzati nel rispetto della pivacy e in base alla tua scelta di pubblicarli o meno nella pagina
   dei negozi on-line basati su opencart italia. Il proprietario dei dati &egrave; LBiT http://www.lbit-solution.it
   al quale richiedere la modifica o cancellazione dei dati. Proseguendo con questa installazione si autorizza LBiT 
