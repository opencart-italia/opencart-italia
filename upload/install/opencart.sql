...
INSERT INTO `oc_api` VALUES (1,'Default','',1,'2017-10-07 00:06:30','2017-10-07 00:06:30');
...
(1,1,'Description'),(2,1,'No. of Cores'),(3,1,'Clockspeed'),(4,1,'test 1'),(5,1,'test 2'),(6,1,'test 3'),(7,1,'test 4'),(8,1,'test 5'),
(9,1,'test 6'),(10,1,'test 7'),(11,1,'test 8'),
(1,2,'Description'),(2,2,'No. of Cores'),(3,2,'Clockspeed'),(4,2,'test 1'),(5,2,'test 2'),(6,2,'test 3'),(7,2,'test 4'),(8,2,'test 5'),
(9,2,'test 6'),(10,2,'test 7'),(11,2,'test 8');
...
(3,1,'Memory'),(4,1,'Technical'),(5,1,'Motherboard'),(6,1,'Processor'),
(3,2,'Memoria'),(4,2,'Tecnico'),(5,2,'Scheda madre'),(6,2,'Processore');
...
(29,7,2,'iPhone 6','index.php?route=product/product&amp;path=57&amp;product_id=49','catalog/demo/banners/iPhone6.jpg',0),
(37,6,2,'HP Banner','index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),
(44,8,2,'NFL','','catalog/demo/manufacturer/nfl.png',0),
(45,8,1,'RedBull','','catalog/demo/manufacturer/redbull.png',0),
(46,8,2,'Sony','','catalog/demo/manufacturer/sony.png',0),
(41,8,1,'Coca Cola','','catalog/demo/manufacturer/cocacola.png',0),
(42,8,2,'Burger King','','catalog/demo/manufacturer/burgerking.png',0),
(43,8,1,'Canon','','catalog/demo/manufacturer/canon.png',0),
(38,8,2,'Harley Davidson','','catalog/demo/manufacturer/harley.png',0),
(39,8,1,'Dell','','catalog/demo/manufacturer/dell.png',0),
(40,8,2,'Disney','','catalog/demo/manufacturer/disney.png',0),
(30,7,1,'MacBookAir','','catalog/demo/banners/MacBookAir.jpg',0),
(47,8,2,'Starbucks','','catalog/demo/manufacturer/starbucks.png',0),
(48,8,1,'Nintendo','','catalog/demo/manufacturer/nintendo.png',0);
...
(28,1,'Monitors','','Monitors','',''),(33,1,'Cameras','','Cameras','',''),(32,1,'Web Cameras','','Web Cameras','',''),
(31,1,'Scanners','','Scanners','',''),(30,1,'Printers','','Printers','',''),(29,1,'Mice and Trackballs','','Mice and Trackballs','',''),
(27,1,'Mac','','Mac','',''),(26,1,'PC','','PC','',''),(17,1,'Software','','Software','',''),(25,1,'Components','','Components','',''),
(24,1,'Phones &amp; PDAs','','Phones &amp; PDAs','',''),
(20,1,'Desktops','&lt;p&gt;\r\n	Example of category description text&lt;/p&gt;\r\n','Desktops','Example of category description',''),
(35,1,'test 1','','test 1','',''),(36,1,'test 2','','test 2','',''),(37,1,'test 5','','test 5','',''),
(38,1,'test 4','','test 4','',''),(39,1,'test 6','','test 6','',''),(40,1,'test 7','','test 7','',''),
(41,1,'test 8','','test 8','',''),(42,1,'test 9','','test 9','',''),(43,1,'test 11','','test 11','',''),
...
INSERT INTO `oc_currency` VALUES (1,'Pound Sterling','GBP','£','','2',0.89142450,1,'2017-10-09 11:34:45'),(2,'US Dollar','USD','$','','2',1.17430000,1,'2017-10-09 11:34:45'),(3,'Euro','EUR','','€','2',1.00000000,1,'2017-10-09 11:48:38');
...
INSERT INTO `oc_geo_zone` VALUES (3,'UK VAT Zone','UK VAT','2009-01-06 23:26:25','2010-02-26 22:33:24'),(4,'Italia','Italia','2009-06-23 01:14:53','2017-10-09 13:46:51');
...
(4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','About Us','',''),
(5,1,'Terms &amp; Condition','&lt;p&gt;\r\n	Terms &amp;amp; Condition&lt;/p&gt;\r\n','Terms &amp; Condition','',''),
(6,1,'Shipping Information','&lt;p&gt;\r\n	Shipping Information&lt;/p&gt;\r\n','Shipping Information','',''),
(3,2,'Privacy Policy','&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n','Privacy Policy','',''),
(4,2,'Chi Siamo','&lt;p&gt;\r\n	Chi Siamo&lt;/p&gt;\r\n','Chi Siamo','',''),
(5,2,'Termini &amp; Condizioni','&lt;p&gt;\r\n	Termini &amp;amp; Condizioni&lt;/p&gt;\r\n','Termini &amp; Condizioni','',''),
(6,2,'Informazioni di Spedizione','&lt;p&gt;\r\n	Informazioni di Spedizione&lt;/p&gt;\r\n','Informazioni di Spedizione','','');
...
(2,'Italiano','it-it','it-IT,it_IT.UTF-8,it_IT,it-it,italiano','it.png','italiano',1,1);
...
INSERT INTO `oc_length_class_description` VALUES (2,2,'Millimeteri','mm'),(1,2,'Centimetri','cm'),(3,2,'Pollici','in'),(1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in');
...
INSERT INTO `oc_location` VALUES (1,'OpenCat Italia store','Via Roma 1, 00100 Roma','+39 06565656','','','','','');
...
(1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),
(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size'),
(1,2,'Radio'),(2,2,'Checkbox'),(4,2,'Text'),(6,2,'Textarea'),(8,2,'Date'),(7,2,'File'),(5,2,'Select'),(9,2,'Time'),
(10,2,'Date &amp; Time'),(12,2,'Delivery Date'),(11,2,'Size');
...
(43,2,1,'1'),(47,4,1,'16GB'),(43,4,1,'8gb'),(42,3,1,'100mhz'),(47,2,1,'4'),
(43,2,2,'1'),(47,4,2,'16GB'),(43,4,2,'8gb'),(42,3,2,'100mhz'),(47,2,2,'4');
...
(439,42,1,20,1,77.0000,'0000-00-00','0000-00-00'),(438,42,1,10,1,88.0000,'0000-00-00','0000-00-00');
...
(1,1,'Refunded'),(2,1,'Credit Issue'),(3,1,'Refund Sent'),(1,2,'Rimborsato'),(2,2,'Credito emesso'),(3,2,'Sostituto inviato');
...
(4,1,'Faulty, please supply details'),(3,1,'Order Error'),(2,1,'Received Wrong Item'),(1,1,'Dead On Arrival'),
(5,1,'Other, please supply details'),(1,2,'Arrivato rotto'),(2,2,'Ricevuto Prodotto Errato'),(3,2,'Errore Ordine!'),(4,2,'Difettoso, si prega di fornire i dettagli'),(5,2,'Altro, si prega di fornire i dettagli');
...
INSERT INTO `oc_return_status` VALUES (2,1,'Waiting product'),(3,1,'Completed'),(1,1,'Pending'),(1,2,'In lavorazione'),(3,2,'Completo'),(2,2,'In Preparazione');
...
(824,0,1,'product_id=48','ipod-classic'),(836,0,1,'category_id=20','desktops'),(834,0,1,'category_id=26','pc'),(835,0,1,'category_id=27','mac'),
(730,0,1,'manufacturer_id=8','apple'),(772,0,1,'information_id=4','about_us'),(768,0,1,'product_id=42','test'),
(789,0,1,'category_id=34','mp3-players'),(781,0,1,'category_id=36','test2'),(774,0,1,'category_id=18','laptop-notebook'),
(775,0,1,'category_id=46','macs'),(776,0,1,'category_id=45','windows'),(777,0,1,'category_id=25','component'),(778,0,1,'category_id=29','mouse'),
(779,0,1,'category_id=28','monitor'),(780,0,1,'category_id=35','test1'),(782,0,1,'category_id=30','printer'),(783,0,1,'category_id=31','scanner'),
(784,0,1,'category_id=32','web-camera'),(785,0,1,'category_id=57','tablet'),(786,0,1,'category_id=17','software'),
(787,0,1,'category_id=24','smartphone'),(788,0,1,'category_id=33','camera'),(790,0,1,'category_id=43','test11'),
(791,0,1,'category_id=44','test12'),(792,0,1,'category_id=47','test15'),(793,0,1,'category_id=48','test16'),
(794,0,1,'category_id=49','test17'),(795,0,1,'category_id=50','test18'),(796,0,1,'category_id=51','test19'),
(797,0,1,'category_id=52','test20'),(798,0,1,'category_id=58','test25'),(799,0,1,'category_id=53','test21'),
(800,0,1,'category_id=54','test22'),(801,0,1,'category_id=55','test23'),(802,0,1,'category_id=56','test24'),
(803,0,1,'category_id=38','test4'),(804,0,1,'category_id=37','test5'),(805,0,1,'category_id=39','test6'),
(806,0,1,'category_id=40','test7'),(807,0,1,'category_id=41','test8'),(808,0,1,'category_id=42','test9'),
(809,0,1,'product_id=30','canon-eos-5d'),(840,0,1,'product_id=47','hp-lp3065'),(811,0,1,'product_id=28','htc-touch-hd'),
(812,0,1,'product_id=43','macbook'),(813,0,1,'product_id=44','macbook-air'),(814,0,1,'product_id=45','macbook-pro'),
(816,0,1,'product_id=31','nikon-d300'),(817,0,1,'product_id=29','palm-treo-pro'),(818,0,1,'product_id=35','product-8'),
(819,0,1,'product_id=49','samsung-galaxy-tab-10-1'),(820,0,1,'product_id=33','samsung-syncmaster-941bw'),
(821,0,1,'product_id=46','sony-vaio'),(837,0,1,'product_id=41','imac'),(823,0,1,'product_id=40','iphone'),
(825,0,1,'product_id=36','ipod-nano'),(826,0,1,'product_id=34','ipod-shuffle'),(827,0,1,'product_id=32','ipod-touch'),
(828,0,1,'manufacturer_id=9','canon'),(829,0,1,'manufacturer_id=5','htc'),(830,0,1,'manufacturer_id=7','hewlett-packard'),
(831,0,1,'manufacturer_id=6','palm'),(832,0,1,'manufacturer_id=10','sony'),(841,0,1,'information_id=6','delivery'),
(842,0,1,'information_id=3','privacy'),(843,0,1,'information_id=5','terms'),
(424,0,2,'product_id=48','ipod-classic'),(436,0,2,'category_id=20','desktops'),(434,0,2,'category_id=26','pc'),(435,0,2,'category_id=27','mac'),
(330,0,2,'manufacturer_id=8','apple'),(372,0,2,'information_id=4','about_us'),(368,0,2,'product_id=42','test'),
(389,0,2,'category_id=34','mp3-players'),(381,0,2,'category_id=36','test2'),(374,0,2,'category_id=18','laptop-notebook'),
(375,0,2,'category_id=46','macs'),(376,0,2,'category_id=45','windows'),(377,0,2,'category_id=25','component'),(378,0,2,'category_id=29','mouse'),
(379,0,2,'category_id=28','monitor'),(380,0,2,'category_id=35','test1'),(382,0,2,'category_id=30','printer'),(383,0,2,'category_id=31','scanner'),
(384,0,2,'category_id=32','web-camera'),(385,0,2,'category_id=57','tablet'),(386,0,2,'category_id=17','software'),
(387,0,2,'category_id=24','smartphone'),(388,0,2,'category_id=33','camera'),(390,0,2,'category_id=43','test11'),
(391,0,2,'category_id=44','test12'),(392,0,2,'category_id=47','test15'),(393,0,2,'category_id=48','test16'),
(394,0,2,'category_id=49','test17'),(395,0,2,'category_id=50','test18'),(396,0,2,'category_id=51','test19'),
(397,0,2,'category_id=52','test20'),(398,0,2,'category_id=58','test25'),(399,0,2,'category_id=53','test21'),
(400,0,2,'category_id=54','test22'),(401,0,2,'category_id=55','test23'),(402,0,2,'category_id=56','test24'),
(403,0,2,'category_id=38','test4'),(404,0,2,'category_id=37','test5'),(405,0,2,'category_id=39','test6'),
(406,0,2,'category_id=40','test7'),(407,0,2,'category_id=41','test8'),(408,0,2,'category_id=42','test9'),
(409,0,2,'product_id=30','canon-eos-5d'),(440,0,2,'product_id=47','hp-lp3065'),(411,0,2,'product_id=28','htc-touch-hd'),
(412,0,2,'product_id=43','macbook'),(413,0,2,'product_id=44','macbook-air'),(414,0,2,'product_id=45','macbook-pro'),
(416,0,2,'product_id=31','nikon-d300'),(417,0,2,'product_id=29','palm-treo-pro'),(418,0,2,'product_id=35','product-8'),
(419,0,2,'product_id=49','samsung-galaxy-tab-10-1'),(420,0,2,'product_id=33','samsung-syncmaster-941bw'),
(421,0,2,'product_id=46','sony-vaio'),(437,0,2,'product_id=41','imac'),(423,0,2,'product_id=40','iphone'),
(425,0,2,'product_id=36','ipod-nano'),(426,0,2,'product_id=34','ipod-shuffle'),(427,0,2,'product_id=32','ipod-touch'),
(428,0,2,'manufacturer_id=9','canon'),(429,0,2,'manufacturer_id=5','htc'),(430,0,2,'manufacturer_id=7','hewlett-packard'),
(431,0,2,'manufacturer_id=6','palm'),(432,0,2,'manufacturer_id=10','sony'),(441,0,2,'information_id=6','delivery'),
(442,0,2,'information_id=3','privacy'),(443,0,2,'information_id=5','terms');
...
INSERT INTO `oc_session` VALUES ('54313d2225a7c2fcb0ea6736e7','{\"language\":\"it-it\",\"currency\":\"EUR\",\"user_id\":\"1\",\"user_token\":\"CZGdEIwsHj1edWBoIcr6rhMEqqfqE7mu\"}','2017-10-09 08:47:14'),('7a779ff111ec3cc678abf6b624','{\"language\":\"en-gb\",\"currency\":\"EUR\"}','2017-10-09 08:41:47'),('8591c11d9383c5e2e98242a3a5','{\"language\":\"it-it\",\"currency\":\"EUR\",\"user_id\":\"1\",\"user_token\":\"YaDsn7qeldvZXqqENL2R4emIWsm1K2Gq\"}','2017-10-08 20:28:26'),('88702603bb507ec18935d55287','{\"language\":\"it-it\",\"currency\":\"USD\"}','2017-10-06 23:22:02'),('915bd3d5a9a808ff05eca19adf','{\"language\":\"it-it\",\"currency\":\"EUR\"}','2017-10-09 12:01:21'),('94490f5e83f69c0f1c99383e1a','{\"language\":\"en-gb\",\"currency\":\"EUR\",\"user_id\":\"1\",\"user_token\":\"wfpI6xEfgdXUsG47FF5Ofqynfx9of8hW\"}','2017-10-09 12:32:28');
...
INSERT INTO `oc_stock_status` VALUES (7,1,'In Magazzino'),(8,1,'Pre-Ordinabile'),(5,1,'Terminato'),(6,1,'2-3 Giorni'),(7,2,'In Magazzino'),(8,2,'Pre-Ordinabile'),(5,2,'Terminato'),(6,2,'2-3 Giorni');
...
INSERT INTO `oc_tax_class` VALUES (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Standard','Iva standard','2011-09-21 22:19:39','2017-10-09 14:05:22');
...
INSERT INTO `oc_tax_rate` VALUES (86,4,'IVA (4%)',4.0000,'P','2011-03-09 21:17:10','2017-10-09 14:03:07'),(87,4,'IVA (22%)',22.0000,'F','2011-09-21 21:49:23','2017-10-09 14:03:17');
...
INSERT INTO `oc_tax_rule` VALUES (129,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);
...
INSERT INTO `oc_user` VALUES (1,1,'admin','23811ac1b9e5ebb7236ee3c258b4a50518de55c5','mwfnaZjtZ','John','Doe','supporto@lbit-solution.it','','','94.177.206.20',1,'2017-10-07 00:06:30');
...
(6,2,'Natale'),(7,2,'Compleanno'),(8,2,'Generale'),
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
(5,1,'Pound ','lb'),(2,1,'Gram','g'),(1,1,'Kilogram','kg'),(6,1,'Ounce','oz'),
(5,2,'Pound ','lb'),(2,2,'Grammi','g'),(1,2,'Chilogramni','kg'),(6,2,'Oncia','oz');
...
-- Dump completed on 2017-10-09 14:15:45
